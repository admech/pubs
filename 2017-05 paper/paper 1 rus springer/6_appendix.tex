...
\end{bmatrix},
$$
где в третьей строке сначала указаны элементы, соответствующие роликам, находящимся в контакте, а затем соответствующие ``свободным'' роликам, упорядоченные по возрастанию индексов так, что ролики одного колеса соседствуют. Матрица $\M$ -- симметрическая, звездочкой обозначены элементы, получающиеся транспонированием верхнего треугольника матрицы.
