...
\begin{enumerate}
    ...
    Вторая группа слагаемых правой части равно нулю, т.к. из \upr{mstar} $\frac{\partial m^*_{33}}{\partial \chi_i} = 0$. Третья группа слагаемых принимает вид
    ...
    \item При $B = 0$ вторая и третья группы квадратичных по $\nu_\alpha$ слагаемых в правой части обращаются в ноль, как и все члены, соответствующие свободным роликам, в левой части (см.\upr{mstar}). В этом случае существенными остаются первые три уравнения системы на $\nu_1,\ \nu_2,\ \nu_3$. Эти уравнения соответствуют безынерционной модели экипажа \cite{ZobovaTatarinov}.
    ...
    $m_33^*\nu_3 = \mathrm{const}$ (причем $m_33 = \mathrm{\const}$) и следует непосредственно из третьего уравнения системы. При $B\neq 0$ имеем
